...
class BundleIndexViewTestCase(TestCase, BookmarkFactoryMixin):
    ...
    def test_render_bundle_list(self):
        ...
        for bundle in bundles:
            ...
            <tr class="list-item" data-bundle-id="{bundle.id}" data-folder="True">
              <td class="list-item-content">
                <div class="d-flex align-center">
                  <div class="drag-handle">
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-secondary" width="16" height="16" viewBox="0 0 24 24" fill="none"
